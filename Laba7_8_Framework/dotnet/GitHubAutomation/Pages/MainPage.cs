...
namespace GitHubAutomation.Pages
{
    class MainPage
    {
        ...
        private const string outputSubscribeMessage = "//*[@class=\"subscription-block__inner\"]/div/div/div[@class=\"text\"]";

        //Переход на стр спецпредложений
        private const string specialPageButton = "//*[@class=\"sitemenu__item cr-sitemenu__promo\"]/a";

        //Авторизация пользователя
        private const string authorizationEmailInput = "//*[@class=\"sc-htpNat jRdltM\"]";
        private const string authorizationPasswordInput = "//*[@class=\"sc-htpNat kEyjWS\"]";
